...
<body>
        ...
        <div class="container">
            ...
            <div class="mover" style="background-color: aliceblue;" >
                <div id="carouselExampleControls" class="carousel slide  " data-bs-ride="carousel">
                    ...
                    <img src="images/homeapp1.webp" alt="...">
                    </div>
                    <div class="carousel-item ">
                    <img src="images/homeapp2.webp" alt="...">
                    </div>
                    <div class="carousel-item ">
                    <img src="images/homeapp3.webp"  alt="...">
                    </div>
                </div>
    ...
    <div class="categories">
        <div class="small-container">
            <div class="row">
                <div class="col-3">
                    <img src="images/homeapp4.webp">
                </div>
                <div class="col-3">
                    <img src="images/homeapp5.webp">
                </div>
                <div class="col-3">
                    <img src="images/homeapp14.webp"-3.jpg">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="small-container">
        ...
        <div class="row">
            <div class="col-4">
                <!-- <a href="productdetail.html"> -->
                    <img src="images/homeapp6.webp"  style="width: 45%;">
                <!-- </a> -->
                <a href="productdetail.html">
                    <h4>SAMSUNG 198 L Direct Cool Single Door 4 Star Refrigerator</h4>
                </a>
            ...
            <div class="col-4">
                <img src="images/homeapp7.webp" style="width: 53%;">
                <h4>Voltas 1.5 Ton 5 Star Split Inverter </h4>
                <div class="rating">
                    <!-- for adding star cdn link-> font awesome 4cdn by stackpath -->
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <img src="images/homeapp8.webp">
                <h4>Pureit purifier</h4>
                <div class="rating">
                    <!-- for adding star cdn link-> font awesome 4cdn by stackpath -->
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <img src="images/homeapp9.webp"  style="width: 45%;">
                <h4>L.G Direct Cool Single Door 4 Star Refrigerator</h4>
                <div class="rating">
                    <!-- for adding star cdn link-> font awesome 4cdn by stackpath -->
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
        ...
        <div class="row">
            <div class="col-4">
                <img src="images/homeapp10.webp" style="width: 57%;"">
                <h4>L.G wshing machine</h4>
                <div class="rating">
                    <!-- for adding star cdn link-> font awesome 4cdn by stackpath -->
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <img src="images/homeapp11.webp" style="width: 60%;">
                <h4>Blue Star 0.8 Ton 3 Star Split Inverter AC - White</h4>
                <div class="rating">
                    <!-- for adding star cdn link-> font awesome 4cdn by stackpath -->
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <img src="images/homeapp12.webp"  style="width: 80%;">
                <h4>V-Guard 15 L Storage Water Geyser </h4>
                <div class="rating">
                    <!-- for adding star cdn link-> font awesome 4cdn by stackpath -->
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <img src="images/homeapp13.webp">
                <h4>L.G washing machine</h4>
                <div class="rating">
                    <!-- for adding star cdn link-> font awesome 4cdn by stackpath -->
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
